...
const Login = (props) => {
  ...
  /*
  * Se valida que los datos ingresados por el usuario, sean correctos, para proceder a iniciar sesion
  * se usa useEffect, para evitar el copy and paste de la condicion setFormIsValid
  * Como enteredEmail y enteredPassword, estaran cambiando constantemente, se asigna como dependencias
  */
  useEffect(() => {
